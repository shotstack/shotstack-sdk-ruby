  ...
  class RichTextAlignment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shotstack::RichTextAlignment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shotstack::RichTextAlignment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      horizontal_validator = EnumAttributeValidator.new('String', ["left", "center", "right"])
      return false unless horizontal_validator.valid?(@horizontal)
      vertical_validator = EnumAttributeValidator.new('String', ["top", "middle", "bottom"])
      return false unless vertical_validator.valid?(@vertical)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] horizontal Object to be assigned
    def horizontal=(horizontal)
      validator = EnumAttributeValidator.new('String', ["left", "center", "right"])
      unless validator.valid?(horizontal)
        fail ArgumentError, "invalid value for \"horizontal\", must be one of #{validator.allowable_values}."
      end
      @horizontal = horizontal
    end
