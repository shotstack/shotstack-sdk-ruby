  ...
  class GetModel200ResponsePricing
    ...
    def self.openapi_types
      {
        ...
        :'tiered_by' => :'GetModel200ResponsePricingTieredBy',
        :'quantity' => :'GetModel200ResponsePricingQuantity',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'tiered_by')
        self.tiered_by = attributes[:'tiered_by']
      end
    ...
    def hash
      [credits, tiered_by, quantity, effective_from].hash
    end
