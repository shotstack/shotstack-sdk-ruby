...
module Shotstack
  ...
  class ImageAsset
    ...
    def valid?
      ...
      resolution_validator = EnumAttributeValidator.new('String', ["1K", "2K", "4K"])
    ...
    def resolution=(resolution)
      validator = EnumAttributeValidator.new('String', ["1K", "2K", "4K"])
    ...
    def hash
      [type, src, prompt, model, resolution, aspect_ratio, crop].hash
    end
